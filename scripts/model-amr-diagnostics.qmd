...
drawslistout <- 
  read_rds(here("data_processed/drawslistout.rda"))

fitlistout <-
  read_rds(here("data_processed/fitlistout.rda"))

mod_diagnostics_df <-
  read_rds(here("data_processed/mod_diagnostics_df.rda"))

outcome_vars <- read_rds(here("data_processed/outcome_vars.rda"))
