...
## THIS IS A MODIFICATION OF THE ORIGINAL MODEL-AMR.R SCRIPT TO FIT MODELS #
# FOR BETA LACTAMSES ONLY, SPLIT BY WHETHER THEY ARE BACTEROIDES-ASSOCITED OR #
# NOT ##
...
write_rds(mod_sum_df, here("data_processed/mod_sum_df_bacteroides.rda"), compress = "gz")

write_rds(fitlistout, here("data_processed/fitlistout_bacteroides.rda"), compress = "gz")

write_rds(drawslistout, here("data_processed/drawslistout_bacteroides.rda"), compress = "gz")
...
write_rds(mod_diagnostics_df, 
  here("data_processed/mod_diagnostics_df_bacteroides.rda"), compress = "gz")

write_rds(outcome_vars, here("data_processed/outcome_vars_bacteroides.rda"))
...
write_rds(mod_sum_df, here("data_processed/gp_mod_sum_df_bacteroides.rda"), compress = "gz")

write_rds(fitlistout, here("data_processed/gp_fitlistout_bacteroides.rda"), compress = "gz")

write_rds(drawslistout, here("data_processed/gp_drawslistout_bacteroides.rda"), compress = "gz")
...
write_rds(mod_diagnostics_df, 
  here("data_processed/gp_mod_diagnostics_df_bacteroides.rda"), compress = "gz")

write_rds(outcome_vars, here("data_processed/gp_outcome_vars_bacteroides.rda"))
