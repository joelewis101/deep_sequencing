...
drawslistout <- 
  read_rds(here("data_processed/gp_drawslistout_bacteroides.rda"))

fitlistout <-
  read_rds(here("data_processed/gp_fitlistout_bacteroides.rda"))

mod_diagnostics_df <-
  read_rds(here("data_processed/gp_mod_diagnostics_df_bacteroides.rda"))

outcome_vars <- read_rds(here("data_processed/gp_outcome_vars_bacteroides.rda"))
