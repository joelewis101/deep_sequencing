...
```{r}
#| label: fig-beta-div2
#| fig-cap: "PCA of Bray-Curtis dissimilarity (calculated at species level, relative abundances) stratified by arm and visit. Density plot for each arm/visit combination shows distribution of samples in PCA space; there is a suggestion I think of difference between arm 1, especially visit 0/1 (maximally antibiotic exposed) and arm 3."
pcoa_df <-
