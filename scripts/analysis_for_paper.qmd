...
mod_sum_df_bact |>
  ...
  mutate(
    bacteroides_associated =
      ...
      "Yes", "No"),
    bacteroides_associated = factor(bacteroides_associated, levels =
c("Yes", "No"))
  ) |>
  mutate(
    parameter =
...
p_4a <-
  ...
  theme_bw() +
  theme(
    axis.text.x = element_text(size = 5, angle = 45, hjust = 1), legend.position =
      "none"
  ) +
...
ggsave(here("plots/fig4.svg"), width = 13, height = 12)
```
...
ggsave(here("plots/sfig1.svg"), width = 8, height = 10)
...
ggsave(here("plots/sfig2.svg"), width = 10, height = 13)
```
...
ggsave(here("plots/sfig3.svg"), width = 10, height = 6)
```
...
ggsave(here("plots/sfig4.svg"), width = 13.5, height = 15)
```
...
ggsave(here("plots/sfig5.svg"), width = 14, height = 10)
```
...
ggsave(here("plots/sfig6.svg"), height = 18, width = 14)
```
...
ggsave(here("plots/sfig7.svg"), width = 14, height = 24)
```
...
ggsave(here("plots/sfig7.svg"), width = 12, height = 12)
```
...
ggsave(here("plots/sfig9.svg"), width = 10, height = 6)
```
...
ggsave(here("plots/sfig8.svg"), height = 18, width = 14)
```
