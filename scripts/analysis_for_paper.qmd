...
p_4a / p_4b + plot_layout(heights = c(1,1)) + plot_annotation(tag_levels = "A")

ggsave(here("plots/fig4.pdf"), width = 13, height = 8)
...
p_s7a / p_s7b / p_s7c + plot_annotation(tag_levels = "A") + plot_layout(guides =
  "collect")
