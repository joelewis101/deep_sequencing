...
ggsave(here("plots/sfig08.pdf"), width = 14, height = 24)
ggsave(here("plots/sfig08.svg"), width = 14, height = 24)
```
...
ggsave(here("plots/sfig09.pdf"), width = 12, height = 12)
ggsave(here("plots/sfig09.svg"), width = 12, height = 12)
```
...
ggsave(here("plots/sfig10.pdf"), width = 10, height = 6)
ggsave(here("plots/sfig10.svg"), width = 10, height = 6)
```
...
ggsave(here("plots/sfig11.pdf"), height = 18, width = 14)
ggsave(here("plots/sfig11.svg"), height = 18, width = 14)
```
...
ggsave(here("plots/sfig12.pdf"), sf, width = 5, height = 5)
ggsave(here("plots/sfig12.svg"), sf, width = 5, height = 5)
```
...
estimate_richness(biom, measures = "Shannon") |>
  ...
  theme_bw() +
  labs(y = "Shannon Diversity", x = "", fill = "Sample Type", color =
    "Sample Type") +
    theme(legend.position = "none")
...
ggsave(here("plots/sfig13.pdf"), sf, width = 12, height = 10)
ggsave(here("plots/sfig13.svg"), sf, width = 12, height = 10)
