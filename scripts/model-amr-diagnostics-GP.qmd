---
title: DASSIM deep sequencing resistome models diagnostics - Gaussian Process models
date: today
...
fitlistout <-
  read_rds(here("data_processed/gp_fitlistout.rda"))

mod_diagnostics_df <-
  read_rds(here("data_processed/gp_mod_diagnostics_df.rda"))

outcome_vars <- read_rds(here("data_processed/gp_outcome_vars.rda"))
