---
title: DASSIM deep sequencing resfinderFG models diagnostics - Gaussian Process models
date: today
...
fitlistout <-
  read_rds(here("data_processed/resfinderFGmodel_fitted-model-list.rda"))

mod_diagnostics_df <-
  read_rds(here("data_processed/resfinderFGmodel_diagnostics.rda"))

outcome_vars <- read_rds(here("data_processed/resfinderFGmodel_outcome-vars.rda"))
