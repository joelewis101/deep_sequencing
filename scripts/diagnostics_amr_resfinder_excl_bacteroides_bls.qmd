...
drawslistout <- 
  read_rds(here("data_processed/resfindermodel_posterior-draws-list_bacteroidesbls-stratified.rda"))

fitlistout <-
  read_rds(here("data_processed/resfindermodel_fitted-model-list_bacteroidesbls-stratified.rda"))

mod_diagnostics_df <-
  read_rds(here("data_processed/resfindermodel_diagnostics_bacteroidesbls-stratified.rda"))

outcome_vars <- read_rds(here("data_processed/resfindermodel_outcomes-var_bacteroidesbls-stratified.rda"))
